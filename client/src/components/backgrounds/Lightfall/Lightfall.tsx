...
const Lightfall: React.FC<LightfallProps> = ({
  ...
  useEffect(() => {
    ...
    // The fragment shader raymarches per pixel, so cost scales with device pixel
    // ratio quadratically. Cap it well below what retina/high-DPI screens report
    // (often 2-3x) to keep this a background flourish, not a GPU load test.
    ...
    const onVisibilityChange = () => {
      visibility.tabVisible = !document.hidden;
      recomputeVisible();
    };
